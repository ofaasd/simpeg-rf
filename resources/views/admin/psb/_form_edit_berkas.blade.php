        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body text-center" id='contentktp'>
                @if(!empty($berkas->file_ktp))
                    ...
                    @endphp
                    @if($ekstensi == "pdf")
                      <object data="https://psb.ppatq-rf.id/assets/images/upload/file_rapor/{{$berkas->file_ktp}}" type="application/pdf" width="100%" height="400">
                        <p>PDF Link : <a href="https://psb.ppatq-rf.id/assets/images/upload/file_rapor/{{$berkas->file_ktp}}">to the PDF!</a></p>
                      </object>
                    @else
