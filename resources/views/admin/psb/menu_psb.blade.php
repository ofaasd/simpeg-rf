<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link {{ (Request::segment(2)=='validasi')?'active':'' }}" href="{{url('psb_new/validasi')}}"><i class='mdi mdi-account-multiple-outline me-1 mdi-20px'></i>Validasi</a></li>
