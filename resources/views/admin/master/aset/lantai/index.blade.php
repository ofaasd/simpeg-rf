                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm" role="group" aria-label="First group">
                      <button type="button" id="btnEdit" data-id="{{$row->id}}" class="btn btn-primary edit-lantai waves-effect" data-status="lantai"><i class="mdi mdi-pencil me-1"></i></button>
