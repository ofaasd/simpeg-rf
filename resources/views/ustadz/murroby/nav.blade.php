<div class="row">
  <div class="col-md-12">
    ...
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link {{ (Request::segment(2)=='perilaku')?'active':'' }}" href="{{url('murroby/perilaku')}}"><i class='mdi mdi-dance-pole me-1 mdi-20px'></i>Perilaku</a></li>
      <li class="nav-item"><a class="nav-link {{ (Request::segment(2)=='kelengkapan')?'active':'' }}" href="{{url('murroby/kelengkapan')}}"><i class='mdi mdi-bag-personal me-1 mdi-20px'></i>Kelengkapan</a></li>
      ...
      <li class="nav-item"><a class="nav-link {{ (Request::segment(2)=='perilaku')?'active':'' }}" href="{{url('murroby/perilaku/' . $id)}}"><i class='mdi mdi-dance-pole me-1 mdi-20px'></i>Perilaku</a></li>
      <li class="nav-item"><a class="nav-link {{ (Request::segment(2)=='kelengkapan')?'active':'' }}" href="{{url('murroby/kelengkapan/' . $id)}}"><i class='mdi mdi-bag-personal me-1 mdi-20px'></i>Kelengkapan</a></li>
