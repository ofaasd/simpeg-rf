...
$(function () {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var statusLabels = {
              '0': { label: 'Aktif', badge: 'success' },
              '1': { label: 'Lulus/Alumni', badge: 'primary' },
              '2': { label: 'Boyong/Keluar', badge: 'warning' },
              '3': { label: 'Meninggal', badge: 'danger' }
            };
  ...
  $('#add-santri-provinsi').on('change', function () {
